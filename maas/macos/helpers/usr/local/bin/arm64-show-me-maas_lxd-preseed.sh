      ...
      apt:
        ...
        security:
          - arches: [arm64]
            ...
            search: ['http://us.ports.archive.ubuntu.com/ubuntu', 'http://ports.archive.ubuntu.com/ubuntu']
        sources_list: |
          deb [arch=arm64] \$PRIMARY \$RELEASE main universe restricted multiverse
          deb [arch=arm64] \$PRIMARY \$RELEASE-updates main universe restricted multiverse
          deb [arch=arm64] \$PRIMARY \$RELEASE-backports main universe restricted multiverse
          deb [arch=arm64] \$SECURITY \$RELEASE-security main universe restricted multiverse
        sources:
          maas-3.2-focal.list:
            source: 'deb [arch=arm64] https://ppa.launchpadcontent.net/maas/3.2/ubuntu focal main'
